                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Add New Designation</h4>
                                ...
                                <div class="card-body">                    
                                    <form  method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" maxlength="25" name="designationName" id="defaultconfig" placeholder="Enter Designation Name"/>
                                        </div>
                                        <button type="submit" name="add_Department" class="btn btn-primary mt-2">Save</button>    
                                    </form>
                                    <?php 
                                        if(isset($_POST['add_Department']) && isset($_POST['designationName']))
                                           {
                                                $designationName = mysqli_real_escape_string($db,$_POST['designationName']);
                                                $added_by = $_SESSION['admin_name'];
                                                $department = mysqli_query($db,"INSERT INTO `designation` (`ID`, `designation_name`, `added_by`, `deletedStatus`, `created_at`) VALUES (NULL, '$designationName', '$added_by', '0', current_timestamp())");
                                                if($department == TRUE)
                                                {
